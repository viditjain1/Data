...
qqghyp(ghdfit, line = TRUE, ghyp.col = "red",
       ...
       main ="", cex = 0.8)
qqghyp(hypfit, add = TRUE, ghyp.pch = 2, ghyp.col = "blue", gaussian = FALSE,
       line = FALSE, cex = 0.8)
qqghyp(nigfit, add = TRUE, ghyp.pch = 2, ghyp.col = "blue", gaussian = FALSE,
       line = FALSE, cex = 0.8)
...
LRghdnig <- lik.ratio.test(ghdfit, hypfit)
